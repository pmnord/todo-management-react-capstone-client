...
const Tag = (props) => {
    ...
    return (
        <span onMouseEnter={() => {setShowDeleteButton(true)}} onMouseLeave={() => {setShowDeleteButton(false)}} className="tag">

            {props.title}
            {showDeleteButton ?

            <svg className="tag__x" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
