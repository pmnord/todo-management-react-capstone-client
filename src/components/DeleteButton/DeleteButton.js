...
export default function DeleteButton({ thingDeleted, deleteCallback, hue, id }) {
    ...
    return (
        <span className="DeleteButton">
            <svg onClick={() => setShowConfirmBox(!showConfirmBox)} className="DeleteButton__x" width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
